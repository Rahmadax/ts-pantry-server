-- Revert disputeworkflow:create_camunda_identity from pg
...
drop index if exists ACT_IDX_TENANT_MEMB;
drop index if exists ACT_IDX_TENANT_MEMB_USER;
drop index if exists ACT_IDX_TENANT_MEMB_GROUP;
